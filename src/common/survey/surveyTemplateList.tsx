...
class SurveyTemplateList extends React.Component<Props, any> { 
    render() {
        return (
                ...
                <div>
                    <div className="wds-m-b-2 sm-all-templates-tab__category-heading sm-all-templates-tab__category-heading--no-tabs">
                        <div className="sm-all-templates-tab__category-heading--inner">
                            <span className="wds-type--section-title">Most Popular</span>
                        </div>
                    </div>
                        ...
                        <div data-testid="LimitedList__Container" className="wds-w-100">
                            <div className="wds-w-100 wds-flex wds-flex--y">
                                <div className="sm-limited-list__items--column">
                                    ...
                                    <div role="button" onClick={() =>  this.props.showModal(true, 3)} className="wds-card sm-base-list-item sm-survey-template-card" data-testid="SurveyTemplateCard_Container">
                                    ...
                                    <div role="button" onClick={() =>  this.props.showModal(true, 4)} className="wds-card sm-base-list-item sm-survey-template-card" data-testid="SurveyTemplateCard_Container">
                                        <div className="wds-grid__row wds-h-100 sm-base-list-item__container">
                                            <div className="wds-flex wds-flex--y-center sm-base-list-item__inner wds-grid__col">
                                                <div className="wds-flex wds-flex--y">
                                    ...
                                    <div role="button" onClick={() =>  this.props.showModal(true, 5)} className="wds-card sm-base-list-item sm-survey-template-card" data-testid="SurveyTemplateCard_Container">
                                        <div className="wds-grid__row wds-h-100 sm-base-list-item__container">
                                            <div className="wds-flex wds-flex--y-center sm-base-list-item__inner wds-grid__col">
                                                <div className="wds-flex wds-flex--y">
                                    ...
                                    <div role="button" onClick={() =>  this.props.showModal(true, 2)} className="wds-card sm-base-list-item sm-survey-template-card" data-testid="SurveyTemplateCard_Container">
                                        <div className="wds-grid__row wds-h-100 sm-base-list-item__container">
                                            <div className="wds-flex wds-flex--y-center sm-base-list-item__inner wds-grid__col">
                                                <div className="wds-flex wds-flex--y">
                                                    <span className="wds-type--dark wds-type--card-title sm-survey-template-card__title">Standard Questions Template</span>
                                                    <div>
                                                        <span className="wds-type--dark-muted wds-type--body-sm">8 questions</span>
                                                    </div>
                                                </div>
