...
class EditForm extends React.Component<Props, IState, any> {
    ...
    render() {
      ...
      return (
        <div>
          <Form.Item>
            <label className="sm-label" style={{ marginBottom: '0' }}>EMAIL COLOR THEME:</label>
            <div style={{ display: 'inline-block', marginLeft: '20px', lineHeight: 0, bottom: '-3px', position: 'absolute' }}>
              ...
              <div style={{ position: 'absolute', zIndex: 2 }}>
                ...
                <SketchPicker color={ this.state.backgroundColor ? this.state.backgroundColor : '#fff' } onChange={ this.handleChange } />
              </div> 
            : null }
            </div>
          </Form.Item>
          ...
          <Form.Item {...formItemLayout} >
            ...
            {/* <RichTextEditor 
              ...
              defaultValue={this.state.collector.subject ? (this.state.collector.subject.indexOf(`<p>`) ? this.state.collector.subject : `<p>${this.state.collector.subject}</p>`) : `<p></p>`} 
            ...
            })(<Input className="wds-input wds-input--md wds-input--stretched" onChange={this.onChange} placeholder="Subject" /*style={{ display: 'none' }}*/ />)}
          </Form.Item>
          ...
          <Form.Item {...formItemLayout} >
            ...
            <RichTextEditor
              ...
              theme={`snow`}
              fontColor={this.state.fontColor}
              defaultValue={this.state.collector.message ? (this.state.collector.message.indexOf(`<p>`) ? this.state.collector.message : `<p>${this.state.collector.message}</p>`) : `<p></p>`} 
              onChange={this.onRichChange}
            ...
            })(<TextArea style={{ display: 'none' }} /*className="wds-textarea wds-textarea--sm wds-textarea--stretched" onChange={this.onTextAreaChange} placeholder="Message" rows={10}*//>)}
          </Form.Item>
