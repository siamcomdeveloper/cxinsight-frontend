...
import ScoreMonthlyProjectsComparison from '../ScoreMonthlyProjectsComparison';
import ScoreYearlyProjectsComparison from '../ScoreYearlyProjectsComparison';
...
class ScoreRow extends React.Component<IProps, IState> { 
    ...
    public componentDidMount() { 
        try{
            ...
            this.setState({ 
                ...
                // console.log('after checkboxOptions', this.state.checkboxOptions);
            ...
            BaseService.post(this.props.match.params.xSite, "/frontendlog/", { method: `comparison scoreRow componentDidMount catch`, message: `catch: ${error}` }, getJwtToken()).then( (rp) => { console.log(`catch: ${error}`); });
        }
    }
    ...
    generateMonthChartData = (diffMonthsAbs: any, monthsValue: any) => {
        try{
            ...
            toastr.error('Something went wrong!, please refresh the page or try again later.');
            BaseService.post(this.props.match.params.xSite, "/frontendlog/", { method: `comparison scoreRow generateMonthChartData catch`, message: `catch: ${error}` }, getJwtToken()).then( (rp) => { console.log(`catch: ${error}`); });
    ...
    generateYearChartData = (diffYearsAbs: any, yearsValue: any) => {
        try{
            ...
            toastr.error('Something went wrong!, please refresh the page or try again later.');
            BaseService.post(this.props.match.params.xSite, "/frontendlog/", { method: `comparison scoreRow generateYearChartData catch`, message: `catch: ${error}` }, getJwtToken()).then( (rp) => { console.log(`catch: ${error}`); });
            return [null, null, null];
        }
    }
    ...
    tabsCallback(key: any) {
        try{
            ...
            toastr.error('Something went wrong!, please refresh the page or try again later.');
            BaseService.post(this.props.match.params.xSite, "/frontendlog/", { method: `comparison scoreRow tabsCallback catch`, message: `catch: ${error}` }, getJwtToken()).then( (rp) => { console.log(`catch: ${error}`); });
        }
    }
                            ...
                            <div className="monthly-comparison-report">
                                <div className="monthly-comparison-report-container">
                                    <div className="sm-chart">
                                        <ScoreMonthlyProjectsComparison height={400} data={this.state.monthChartData} padding={['20', '40', '150', '60']} rotate={30} disable={ false }/>
                                    </div>
                                    {/* <Collapse accordion>
                        ...
                        <TabPane tab="Yearly Comparison Report" key="yearly">
                            <div className="yearly-comparison-report">
                                <div className="yearly-comparison-report-container">
                                    <div className="sm-chart">
                                        <ScoreYearlyProjectsComparison height={400} data={this.state.yearChartData} padding={['20', '80', '170', '60']} rotate={30} disable={ false }/>
                                    </div>
                                    <Collapse accordion>
