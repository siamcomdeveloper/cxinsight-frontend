...
const BulletGraph3: React.StatelessComponent<IProps> = (props) => { 
    ...
    try{
          ...
          //   data={[1]}
            ...
            {props.data.map((data: any) => {
                ...
                >
                  ...
                  //   color={ data.actual <= 4 ? "#d04f67" : data.actual >= 8 ? "#00BF6F" : "#fec459" }
                    color={ data.actual <= 4 ? "red" : data.actual >= 8 ? "#00BF6F" : "orange" }
                    size={20}
                    >
                    {/* <Label
                        content='title'
      ...
      // BaseService.post("/frontendlog/", { method: 'BulletGraph3 catch', message: `catch: ${error}` }, getJwtToken()).then( (rp) => { console.log(`catch: ${error}`); });
      return (<div></div>); 
    }
}
export default BulletGraph3;