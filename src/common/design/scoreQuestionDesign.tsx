...
class ScoreQuestionDesign extends React.Component<IProps, IState> { 
    ...
    constructor(props: IProps) {
      ...
      // console.log('ScoreQuestionDesign constructor', props);
    }

    public componentDidMount() { 
      // console.log('ScoreQuestionDesign componentDidMount');
        if(this.props.question.imageEnabled) this.renderImage();
    }

    public renderImage() { 
        try{
            // console.log('ScoreQuestionDesign renderImage');
            ...
            BaseService.post(this.props.match.params.xSite, "/frontendlog/", { method: `design scoreQuestionDesign renderImage catch`, message: `catch: ${error}` }, getJwtToken()).then( (rp) => { console.log(`catch: ${error}`); });
        }
    }
                            ...
                            <div className="question-body clearfix notranslate ">
                                ...
                                <table className="question-matrix-nps-table table-reset" cellSpacing="0" role="presentation">
                                    ...
                                    <tbody>
                                        ...
                                        <tr data-nps>
                                            <td className="nps-radio-button-container no-touch touch-sensitive">
                                                <div id={"question-"+this.props.question.no+"-NPS-score0"} className="radio-button-container">
                                                    ...
                                                    <label id={"question-"+this.props.question.no+"-NPS-score0-label"} className={ 'answer-label radio-button-label no-touch touch-sensitive clearfix '} style={{ fontFamily: this.props.question.globalFont, fontSize: this.props.question.globalFontSize }}>
                                            ...
                                            <td className="nps-radio-button-container no-touch touch-sensitive">
                                                <div id={"question-"+this.props.question.no+"-NPS-score1"} className="radio-button-container">
                                                    ...
                                                    <label id={"question-"+this.props.question.no+"-NPS-score1-label"} className={ 'answer-label radio-button-label no-touch touch-sensitive clearfix '} style={{ fontFamily: this.props.question.globalFont, fontSize: this.props.question.globalFontSize }}>
                                            ...
                                            <td className="nps-radio-button-container no-touch touch-sensitive">
                                                <div id={"question-"+this.props.question.no+"-NPS-score2"} className="radio-button-container">
                                                    ...
                                                    <label id={"question-"+this.props.question.no+"-NPS-score2-label"} className={ 'answer-label radio-button-label no-touch touch-sensitive clearfix '} style={{ fontFamily: this.props.question.globalFont, fontSize: this.props.question.globalFontSize }}>
                                            ...
                                            <td className="nps-radio-button-container no-touch touch-sensitive">
                                                <div id={"question-"+this.props.question.no+"-NPS-score3"} className="radio-button-container">
                                                    ...
                                                    <label id={"question-"+this.props.question.no+"-NPS-score3-label"} className={ 'answer-label radio-button-label no-touch touch-sensitive clearfix '} style={{ fontFamily: this.props.question.globalFont, fontSize: this.props.question.globalFontSize }}>
                                            ...
                                            <td className="nps-radio-button-container no-touch touch-sensitive">
                                                <div id={"question-"+this.props.question.no+"-NPS-score4"} className="radio-button-container">
                                                    ...
                                                    <label id={"question-"+this.props.question.no+"-NPS-score4-label"} className={ 'answer-label radio-button-label no-touch touch-sensitive clearfix '} style={{ fontFamily: this.props.question.globalFont, fontSize: this.props.question.globalFontSize }}>
                                            ...
                                            <td className="nps-radio-button-container no-touch touch-sensitive">
                                                <div id={"question-"+this.props.question.no+"-NPS-score5"} className="radio-button-container">
                                                    ...
                                                    <label id={"question-"+this.props.question.no+"-NPS-score5-label"} className={ 'answer-label radio-button-label no-touch touch-sensitive clearfix '} style={{ fontFamily: this.props.question.globalFont, fontSize: this.props.question.globalFontSize }}>
                                            ...
                                            <td className="nps-radio-button-container no-touch touch-sensitive">
                                                <div id={"question-"+this.props.question.no+"-NPS-score6"} className="radio-button-container">
                                                    ...
                                                    <label id={"question-"+this.props.question.no+"-NPS-score6-label"} className={ 'answer-label radio-button-label no-touch touch-sensitive clearfix '} style={{ fontFamily: this.props.question.globalFont, fontSize: this.props.question.globalFontSize }}>
                                            ...
                                            <td className="nps-radio-button-container no-touch touch-sensitive">
                                                <div id={"question-"+this.props.question.no+"-NPS-score7"} className="radio-button-container">
                                                    ...
                                                    <label id={"question-"+this.props.question.no+"-NPS-score7-label"} className={ 'answer-label radio-button-label no-touch touch-sensitive clearfix '} style={{ fontFamily: this.props.question.globalFont, fontSize: this.props.question.globalFontSize }}>
                                            ...
                                            <td className="nps-radio-button-container no-touch touch-sensitive">
                                                <div id={"question-"+this.props.question.no+"-NPS-score8"} className="radio-button-container">
                                                    ...
                                                    <label id={"question-"+this.props.question.no+"-NPS-score8-label"} className={ 'answer-label radio-button-label no-touch touch-sensitive clearfix '} style={{ fontFamily: this.props.question.globalFont, fontSize: this.props.question.globalFontSize }}>
                                            ...
                                            <td className="nps-radio-button-container no-touch touch-sensitive">
                                                <div id={"question-"+this.props.question.no+"-NPS-score9"} className="radio-button-container">
                                                    ...
                                                    <label id={"question-"+this.props.question.no+"-NPS-score9-label"} className={ 'answer-label radio-button-label no-touch touch-sensitive clearfix '} style={{ fontFamily: this.props.question.globalFont, fontSize: this.props.question.globalFontSize }}>
                                            ...
                                            <td className="nps-radio-button-container no-touch touch-sensitive">
                                                <div id={"question-"+this.props.question.no+"-NPS-score10"} className="radio-button-container">
                                                    ...
                                                    <label id={"question-"+this.props.question.no+"-NPS-score10-label"} className={ 'answer-label radio-button-label no-touch touch-sensitive clearfix '} style={{ fontFamily: this.props.question.globalFont, fontSize: this.props.question.globalFontSize }}>
...
export default ScoreQuestionDesign;