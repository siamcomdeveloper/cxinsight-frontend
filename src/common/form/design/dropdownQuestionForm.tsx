...
class DropdownQuestionForm extends React.Component<Props, IState, any> {
    ...
    // console.log('DropdownQuestionForm constructor', props);
    }

    componentDidMount() { 

        // console.log('DropdownQuestionForm componentDidMount');
    ...
    componentWillReceiveProps(props: any) {
      // console.log('DropdownQuestionForm componentWillReceiveProps', props);
    }
                ...
                try{
                    if (rp.Status) {
                      // console.log(rp);
                        ...
                        toastr.error('Something went wrong!, please refresh the page or try again later.');
                        BaseService.post(this.props.match.params.xSite, "/frontendlog/", { method: `dropdownQuestionForm onSaveCopy BaseService.update /question/design/copy/${this.state.survey.id}/${this.state.question.question_id}/${this.state.question.type_id}/${this.state.copyToPageOption}/${this.state.copyToQuestionOption}/${toPosition} else`, message: `Messages: ${rp.Messages} | Exception: ${rp.Exception}` }, getJwtToken()).then( (rp) => { console.log(`Messages: ${rp.Messages} | Exception: ${rp.Exception}`); });
                    }
                }catch(error){ 
                    toastr.error('Something went wrong!, please refresh the page or try again later.');
                    BaseService.post(this.props.match.params.xSite, "/frontendlog/", { method: `dropdownQuestionForm onSaveCopy BaseService.update /question/design/copy/${this.state.survey.id}/${this.state.question.question_id}/${this.state.question.type_id}/${this.state.copyToPageOption}/${this.state.copyToQuestionOption}/${toPosition} catch`, message: `catch: ${error}` }, getJwtToken()).then( (rp) => { console.log(`catch: ${error}`); });
                }
            }
        );
    }
                ...
                try{
                    if (rp.Status) {
                      // console.log(rp);
                        ...
                        // toastr.error(rp.Messages);
                        toastr.error('Something went wrong!, please refresh the page or try again later.');
                        BaseService.post(this.props.match.params.xSite, "/frontendlog/", { method: `dropdownQuestionForm onSaveMove BaseService.update /question/design/move/${direction}/${this.state.survey.id}/${this.state.question.question_id}/${this.state.question.page_no}/${this.state.question.order_no}/${this.state.moveToPageOption}/${this.state.moveToQuestionOption}/${toPosition}/${oneOnPage} else`, message: `Messages: ${rp.Messages} | Exception: ${rp.Exception}` }, getJwtToken()).then( (rp) => { console.log(`Messages: ${rp.Messages} | Exception: ${rp.Exception}`); });
                    }
                }catch(error){ 
                    toastr.error('Something went wrong!, please refresh the page or try again later.');
                ...
                (rp) => {
                    try{
                        if (rp.Status) {
                            ...
                            // toastr.error(rp.Messages);
                            toastr.error('Something went wrong!, please refresh the page or try again later.');
                            BaseService.post(this.props.match.params.xSite, "/frontendlog/", { method: `dropdownQuestionForm onSaveLogic BaseService.update /question/design/update/${this.state.survey.id}/${this.state.question.question_id}/${this.state.question.type_id} else`, message: `Messages: ${rp.Messages} | Exception: ${rp.Exception}` }, getJwtToken()).then( (rp) => { console.log(`Messages: ${rp.Messages} | Exception: ${rp.Exception}`); });
                        }
                    }catch(error){ 
                        toastr.error('Something went wrong!, please refresh the page or try again later.');
                        BaseService.post(this.props.match.params.xSite, "/frontendlog/", { method: `dropdownQuestionForm onSaveLogic BaseService.update /question/design/update/${this.state.survey.id}/${this.state.question.question_id}/${this.state.question.type_id} catch`, message: `catch: ${error}` }, getJwtToken()).then( (rp) => { console.log(`catch: ${error}`); });
                    }
                }
            );
        }catch(error){
            toastr.error('Something went wrong!, please refresh the page or try again later.');
            BaseService.post(this.props.match.params.xSite, "/frontendlog/", { method: `dropdownQuestionForm onSaveLogic catch`, message: `catch: ${error}` }, getJwtToken()).then( (rp) => { console.log(`catch: ${error}`); });
        }
    }
    ...
    onSaveOptions(){
        try{
                ...
                BaseService.update(this.props.match.params.xSite, "/question/design/update/", this.state.survey.id + '/' + this.state.question.question_id, 
                    ...
                    (rp) => {
                        ...
                        // console.log(rp);
                            ...
                            BaseService.update(this.props.match.params.xSite, "/question/design/update/", this.state.survey.id + '/' + this.state.question.question_id + '/' + this.state.question.type_id, 
                                ...
                                (rp) => {
                                    if (rp.Status) {
                                        ...
                                        // toastr.error(rp.Messages);
                                        toastr.error('Something went wrong!, please refresh the page or try again later.');
                                        BaseService.post(this.props.match.params.xSite, "/frontendlog/", { method: `dropdownQuestionForm onSaveOptions BaseService.update /question/design/update/${this.state.survey.id}/${this.state.question.question_id}/${this.state.question.type_id} else`, message: `Messages: ${rp.Messages} | Exception: ${rp.Exception}` }, getJwtToken()).then( (rp) => { console.log(`Messages: ${rp.Messages} | Exception: ${rp.Exception}`); });
                                    }
                                }
                            );
                        } else {
                            // toastr.error(rp.Messages);
                            toastr.error('Something went wrong!, please refresh the page or try again later.');
                            BaseService.post(this.props.match.params.xSite, "/frontendlog/", { method: `dropdownQuestionForm onSaveOptions BaseService.update /question/design/update/${this.state.survey.id}/${this.state.question.question_id} else`, message: `Messages: ${rp.Messages} | Exception: ${rp.Exception}` }, getJwtToken()).then( (rp) => { console.log(`Messages: ${rp.Messages} | Exception: ${rp.Exception}`); });
                        }
                    }
                );
            }
            ...
            toastr.error('Something went wrong!, please refresh the page or try again later.');
            BaseService.post(this.props.match.params.xSite, "/frontendlog/", { method: `dropdownQuestionForm onSaveOptions catch`, message: `catch: ${error}` }, getJwtToken()).then( (rp) => { console.log(`catch: ${error}`); });
        }
    ...
    onSaveEdit(){
        try{
            ...
            //     // set answerChoice choice and weight
            //     answerChoiceFields.push('answer_choice['+(i)+']');
            // }
                    ...
                    (rp) => {
                        try{
                            ...
                            // console.log(rp);
                                ...
                                BaseService.update(this.props.match.params.xSite, "/question/design/update/", this.state.survey.id + '/' + this.state.question.question_id + '/' + this.state.question.type_id, 
                                    ...
                                    (rp) => {
                                        ...
                                        // console.log(rp);
                                            ...
                                            // toastr.error(rp.Messages);
                                            toastr.error('Something went wrong!, please refresh the page or try again later.');
                                            BaseService.post(this.props.match.params.xSite, "/frontendlog/", { method: `dropdownQuestionForm onSaveEdit BaseService.update /question/design/update/${this.state.survey.id}/${this.state.question.question_id}/${this.state.question.type_id} else`, message: `Messages: ${rp.Messages} | Exception: ${rp.Exception}` }, getJwtToken()).then( (rp) => { console.log(`Messages: ${rp.Messages} | Exception: ${rp.Exception}`); });
                                        }
                                    }
                                );
                                ...
                                // toastr.error(rp.Messages);
                                toastr.error('Something went wrong!, please refresh the page or try again later.');
                                BaseService.post(this.props.match.params.xSite, "/frontendlog/", { method: `dropdownQuestionForm onSaveEdit BaseService.update /question/design/update/${this.state.survey.id}/${this.state.question.question_id} else`, message: `Messages: ${rp.Messages} | Exception: ${rp.Exception}` }, getJwtToken()).then( (rp) => { console.log(`Messages: ${rp.Messages} | Exception: ${rp.Exception}`); });
                            }
                        }catch(error){ 
                            toastr.error('Something went wrong!, please refresh the page or try again later.');
                            BaseService.post(this.props.match.params.xSite, "/frontendlog/", { method: `dropdownQuestionForm onSaveEdit BaseService.update /question/design/update/${this.state.survey.id}/${this.state.question.question_id} catch`, message: `catch: ${error}` }, getJwtToken()).then( (rp) => { console.log(`catch: ${error}`); });
                        }
                    }
                );
            }
            ...
            toastr.error('Something went wrong!, please refresh the page or try again later.');
            BaseService.post(this.props.match.params.xSite, "/frontendlog/", { method: `dropdownQuestionForm onSaveEdit catch`, message: `catch: ${error}` }, getJwtToken()).then( (rp) => { console.log(`catch: ${error}`); });
        }
    }
    ...
    public async renderLogicDropdownPageElement(j: any) {
        try{
            ...
            toastr.error('Something went wrong!, please refresh the page or try again later.');
            BaseService.post(this.props.match.params.xSite, "/frontendlog/", { method: `dropdownQuestionForm renderLogicDropdownPageElement catch`, message: `catch: ${error}` }, getJwtToken()).then( (rp) => { console.log(`catch: ${error}`); });
        }
    }
    ...
    public renderLogicDropdownQuestionElement(j: any, pageChanged?: boolean) {
        try{
            ...
            toastr.error('Something went wrong!, please refresh the page or try again later.');
            BaseService.post(this.props.match.params.xSite, "/frontendlog/", { method: `dropdownQuestionForm renderLogicDropdownQuestionElement catch`, message: `catch: ${error}` }, getJwtToken()).then( (rp) => { console.log(`catch: ${error}`); });
        }
    }
    ...
    public getAllQuestionOptionElementCopy(j: any){
        ...
        // console.log(`allQuestionOptionElementCopy loop ${j} removed`, allQuestionOptionElementCopy);
            ...
            toastr.error('Something went wrong!, please refresh the page or try again later.');
            BaseService.post(this.props.match.params.xSite, "/frontendlog/", { method: `dropdownQuestionForm getAllQuestionOptionElementCopy catch`, message: `catch: ${error}` }, getJwtToken()).then( (rp) => { console.log(`catch: ${error}`); });
        }
    }
    ...
    public async renderElement(key: any) { 
        ...
        // console.log('DropdownQuestionForm renderElement question', this.state.question);
            ...
            //     );
                ...
                // let nodeAnswerChoiceRow = new Array<any>(this.state.choices.length);
                // for(let i = 0; i < nodeAnswerChoiceRow.length; i++) { nodeAnswerChoiceRow[i] = ''; }
                
                // let answerChoiceKeys: any;
                // // let nodeAnswerChoiceRowElement;
                // if(this.state.choices.length === 0){
                //     for(let i = 0 ; i < 2 ; i++){
                //         answerChoiceKeys = this.addAnswerChoice(true, i);
                //     }
                // }
                // else{
                //     for(let i = 0 ; i < 1 ; i++){
                //         answerChoiceKeys = this.addAnswerChoice(true, i);
                //     }
                //     // nodeAnswerChoiceRowElement = nodeAnswerChoiceRow.map((obj, i) => this.addAnswerChoice(true, i));
                // }

                // let parentEl = document.getElementById("answer-choice-row");
                // let childEl = this.getAnswerChoiceRow(answerChoiceKeys);
                // // console.log('childEl', childEl);
                // ReactDOM.render(childEl, parentEl, () => {
                //   // console.log('ReactDOM.render(child, parent, function() done childEl', childEl);
                //     // this.setChoiceWeight();
                //     // let starLabelFieldName = 'answer_choice';
                //     this.props.form.setFieldsValue({
                //         answer_choice: this.state.choices[0],
                //     }, () => console.log('setFieldsValue answer_choice'));
                // });
                ...
                //     //render answer choice tab element
                ...
                //     ReactDOM.render(childEl, parentEl, () => {
                        ...
                        //genarate answer choice row with 2 choice selection
                        //render answer choice row in the tbody element
                        // let parentEl = document.getElementById("answer-choice-row");
                        // let childEl = this.getAllAnswerChoiceRow();
                        // // console.log('childEl', childEl);
                        // ReactDOM.render(childEl, parentEl, () => {

                            //first answer choice add two answer choice auto when no answer choice setting at first
                            // if(this.state.choices.length === 0) for(let i = 0 ; i < 2 ; i++) this.addAnswerChoice(true, 0 , i);
                            // else for(let i = 0 ; i < this.state.choices.length ; i++) this.addAnswerChoice(true, 0, i);
            ...
            toastr.error('Something went wrong!, please refresh the page or try again later.');
            BaseService.post(this.props.match.params.xSite, "/frontendlog/", { method: `dropdownQuestionForm renderElement catch`, message: `catch: ${error}` }, getJwtToken()).then( (rp) => { console.log(`catch: ${error}`); });
        }
                      ...
                      // console.log(`get question ${i} count = `, rp.Data.recordset.length);
                        ...
                        if(rp.Data.recordset.length){
                          ...
                          // console.log(`get question no. ${i} questionPageNo = `, questionPageNo);
                            ...
                            // toastr.error(rp.Messages);
                            toastr.error('Something went wrong!, please refresh the page or try again later.');
                            BaseService.post(this.props.match.params.xSite, "/frontendlog/", { method: `dropdownQuestionForm getPageNo BaseService.get<Question> /question/${surveyId}/${i} else rp.Data.recordset.length`, message: `Messages: ${rp.Messages} | Exception: ${rp.Exception}` }, getJwtToken()).then( (rp) => { console.log(`Messages: ${rp.Messages} | Exception: ${rp.Exception}`); });
                            return false;
                        }
                        ...
                        // toastr.error(rp.Messages);
                        toastr.error('Something went wrong!, please refresh the page or try again later.');
                        BaseService.post(this.props.match.params.xSite, "/frontendlog/", { method: `dropdownQuestionForm getPageNo BaseService.get<Question> /question/${surveyId}/${i} else rp.Status`, message: `Messages: ${rp.Messages} | Exception: ${rp.Exception}` }, getJwtToken()).then( (rp) => { console.log(`Messages: ${rp.Messages} | Exception: ${rp.Exception}`); });
                        return false;
                    }
                }catch(error){
                    toastr.error('Something went wrong!, please refresh the page or try again later.');
                    BaseService.post(this.props.match.params.xSite, "/frontendlog/", { method: `dropdownQuestionForm getPageNo BaseService.get<Question> /question/${surveyId}/${i} catch`, message: `catch: ${error}` }, getJwtToken()).then( (rp) => { console.log(`catch: ${error}`); });
                }
            }//async (rp)
        );//call question api
    }
                ...
                try{
                    if (rp.Status) {
                      ...
                      // console.log(`get question ${no} count = `, rp.Data.recordset.length);
                        ...
                        // toastr.error(rp.Messages);
                        toastr.error('Something went wrong!, please refresh the page or try again later.');
                        BaseService.post(this.props.match.params.xSite, "/frontendlog/", { method: `dropdownQuestionForm getQuestionOptionRow BaseService.get<Question> /question/${this.state.survey.id}/${no} else`, message: `Messages: ${rp.Messages} | Exception: ${rp.Exception}` }, getJwtToken()).then( (rp) => { console.log(`Messages: ${rp.Messages} | Exception: ${rp.Exception}`); });
                        return <option key={this.state.actionKey+'-option-'+no}></option>;
                    }
                }catch(error){
                    toastr.error('Something went wrong!, please refresh the page or try again later.');
                    BaseService.post(this.props.match.params.xSite, "/frontendlog/", { method: `dropdownQuestionForm getQuestionOptionRow BaseService.get<Question> /question/${this.state.survey.id}/${no} catch`, message: `catch: ${error}` }, getJwtToken()).then( (rp) => { console.log(`catch: ${error}`); });
                }
            }//async (rp)
        );//call question api
    ...
    customRequest = (componentsData: any) => {
      // console.log('componentsData', componentsData);
        ...
        .catch(error => {
            toastr.error('Something went wrong!, please refresh the page or try again later.');
            BaseService.post(this.props.match.params.xSite, "/frontendlog/", { method: `dropdownQuestionForm customRequest catch`, message: `catch: ${error}` }, getJwtToken()).then( (rp) => { console.log(`catch: ${error}`); });
    ...
    render() {
        ...
        // console.log(`dropdownQuestionForm render() return(...)`);
...
const dropdownQuestionForm = Form.create<Props>()(DropdownQuestionForm);
