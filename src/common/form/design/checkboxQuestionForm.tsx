...
class CheckboxQuestionForm extends React.Component<Props, IState, any> {
    ...
    constructor(props: Props & FormComponentProps) {
        ...
        // console.log('CheckboxQuestionForm this.props.question', this.props.question);
        // console.log('CheckboxQuestionForm constructor', this.props.survey.total_responses);
        // console.log('CheckboxQuestionForm parseInt(this.props.survey.total_responses as any) > 0', parseInt(this.props.survey.total_responses as any) > 0);
    }

    componentDidMount() { 

        // console.log('CheckboxQuestionForm componentDidMount this.state.alreadyResponded', this.state.alreadyResponded);
        // console.log('CheckboxQuestionForm componentDidMount this.state.isNotTemplateQuestion', this.state.isNotTemplateQuestion);
    ...
    componentWillReceiveProps(props: any) {
      // console.log('CheckboxQuestionForm componentWillReceiveProps', props);
    }
                ...
                try{
                    if (rp.Status) {
                      // console.log(rp);
                        ...
                        toastr.error('Something went wrong!, please refresh the page or try again later.');
                        BaseService.post(this.props.match.params.xSite, "/frontendlog/", { method: `checkboxQuestionForm onSaveCopy BaseService.update /question/design/copy/${this.state.survey.id}/${this.state.question.question_id}/${this.state.question.type_id}/${this.state.copyToPageOption}/${this.state.copyToQuestionOption}/${toPosition} else`, message: `Messages: ${rp.Messages} | Exception: ${rp.Exception}` }, getJwtToken()).then( (rp) => { console.log(`Messages: ${rp.Messages} | Exception: ${rp.Exception}`); });
                    }
                }catch(error){ 
                    toastr.error('Something went wrong!, please refresh the page or try again later.');
                    BaseService.post(this.props.match.params.xSite, "/frontendlog/", { method: `checkboxQuestionForm onSaveCopy BaseService.update /question/design/copy/${this.state.survey.id}/${this.state.question.question_id}/${this.state.question.type_id}/${this.state.copyToPageOption}/${this.state.copyToQuestionOption}/${toPosition} catch`, message: `catch: ${error}` }, getJwtToken()).then( (rp) => { console.log(`catch: ${error}`); });
                }
            }
        );
    }
                ...
                try{
                    if (rp.Status) {
                      // console.log(rp);
                        ...
                        // toastr.error(rp.Messages);
                        toastr.error('Something went wrong!, please refresh the page or try again later.');
                        BaseService.post(this.props.match.params.xSite, "/frontendlog/", { method: `checkboxQuestionForm onSaveMove BaseService.update /question/design/move/${direction}/${this.state.survey.id}/${this.state.question.question_id}/${this.state.question.page_no}/${this.state.question.order_no}/${this.state.moveToPageOption}/${this.state.moveToQuestionOption}/${toPosition}/${oneOnPage} else`, message: `Messages: ${rp.Messages} | Exception: ${rp.Exception}` }, getJwtToken()).then( (rp) => { console.log(`Messages: ${rp.Messages} | Exception: ${rp.Exception}`); });
                    }
                }catch(error){ 
                    toastr.error('Something went wrong!, please refresh the page or try again later.');
                ...
                (rp) => {
                    try{
                        if (rp.Status) {
                            ...
                            // toastr.error(rp.Messages);
                            toastr.error('Something went wrong!, please refresh the page or try again later.');
                            BaseService.post(this.props.match.params.xSite, "/frontendlog/", { method: `checkboxQuestionForm onSaveLogic BaseService.update /question/design/update/${this.state.survey.id}/${this.state.question.question_id}/${this.state.question.type_id} else`, message: `Messages: ${rp.Messages} | Exception: ${rp.Exception}` }, getJwtToken()).then( (rp) => { console.log(`Messages: ${rp.Messages} | Exception: ${rp.Exception}`); });
                        }
                    }catch(error){ 
                        toastr.error('Something went wrong!, please refresh the page or try again later.');
                        BaseService.post(this.props.match.params.xSite, "/frontendlog/", { method: `checkboxQuestionForm onSaveLogic BaseService.update /question/design/update/${this.state.survey.id}/${this.state.question.question_id}/${this.state.question.type_id} catch`, message: `catch: ${error}` }, getJwtToken()).then( (rp) => { console.log(`catch: ${error}`); });
                    }
                }
            );
        }catch(error){
            toastr.error('Something went wrong!, please refresh the page or try again later.');
            BaseService.post(this.props.match.params.xSite, "/frontendlog/", { method: `checkboxQuestionForm onSaveLogic catch`, message: `catch: ${error}` }, getJwtToken()).then( (rp) => { console.log(`catch: ${error}`); });
        }
    }
    ...
    onSaveOptions(){
        try{
            ...
            //     imageKeys = this.props.form.getFieldValue('imageKeys');
            //   // console.log(`onSaveOptions imageKeys`, imageKeys)

            //     //imageSource
            //     // const sourceFieldArr = imageKeys.map((k: any, index: any) => {
            //     sourceFieldArr = imageKeys.map((k: any, index: any) => {
            //       // console.log(`onSaveOptions imageKeys.map k = ${k} index = ${index}`);
            //         return 'image_src['+k+']';
            //     });
            //   // console.log(`onSaveOptions sourceFieldArr`, sourceFieldArr);

            //     this.props.form.validateFields(sourceFieldArr, (err, values) => {
            //       // console.log(`onSaveOptions sourceFieldArr validateFields`, err, values);
            //         if (!err || isNull(err) ) {
            //             pass = true;
            //         }
            //     });
            ...
            if(pass){
                ...
                if(this.state.question.image_enabled){
                    ...
                    const imageKeys = this.props.form.getFieldValue('imageKeys');
                    // imageKeys.map((k: any, index: any) => {
                    //   // console.log(`onSaveOptions imageKeys.map k = ${k} index = ${index}`);
                    // });

                    // const sourceFieldsValueArr = this.props.form.getFieldsValue(sourceFieldArr);
                    // console.log(`onSaveOptions sourceFieldsValueArr`, sourceFieldsValueArr);
                    // console.log(`onSaveOptions this.state.imageSource`, this.state.imageSource);

                    // const sourceFieldsValueArrFilter = sourceFieldsValueArr.image_src.filter(function (item: any) { return item !== null; });
                ...
                BaseService.update(this.props.match.params.xSite, "/question/design/update/", this.state.survey.id + '/' + this.state.question.question_id, 
                    ...
                    (rp) => {
                        ...
                        // console.log(rp);
                            ...
                            BaseService.update(this.props.match.params.xSite, "/question/design/update/", this.state.survey.id + '/' + this.state.question.question_id + '/' + this.state.question.type_id, 
                                ...
                                (rp) => {
                                    if (rp.Status) {
                                        ...
                                        // toastr.error(rp.Messages);
                                        toastr.error('Something went wrong!, please refresh the page or try again later.');
                                        BaseService.post(this.props.match.params.xSite, "/frontendlog/", { method: `checkboxQuestionForm onSaveOptions BaseService.update /question/design/update/${this.state.survey.id}/${this.state.question.question_id}/${this.state.question.type_id} else`, message: `Messages: ${rp.Messages} | Exception: ${rp.Exception}` }, getJwtToken()).then( (rp) => { console.log(`Messages: ${rp.Messages} | Exception: ${rp.Exception}`); });
                                    }
                                }
                            );
                        } else {
                            // toastr.error(rp.Messages);
                            toastr.error('Something went wrong!, please refresh the page or try again later.');
                            BaseService.post(this.props.match.params.xSite, "/frontendlog/", { method: `checkboxQuestionForm onSaveOptions BaseService.update /question/design/update/${this.state.survey.id}/${this.state.question.question_id} else`, message: `Messages: ${rp.Messages} | Exception: ${rp.Exception}` }, getJwtToken()).then( (rp) => { console.log(`Messages: ${rp.Messages} | Exception: ${rp.Exception}`); });
                        }
                    }
                );
            }
            ...
            toastr.error('Something went wrong!, please refresh the page or try again later.');
            BaseService.post(this.props.match.params.xSite, "/frontendlog/", { method: `checkboxQuestionForm onSaveOptions catch`, message: `catch: ${error}` }, getJwtToken()).then( (rp) => { console.log(`catch: ${error}`); });
        }
    ...
    onSaveEdit(){
        try{
            ...
            this.props.form.validateFields(answerChoiceFields, (err, values) => {
                ...
                if (!err || isNull(err) ) {
                    ...
                    answerChoiceKeys.map((k: any, index: any) => {
                        ...
                        // console.log(`answerChoiceHtml`, answerChoiceHtml);
            ...
            if(passAnswerChoiceFields){
                ...
                const jwt = getJwtToken();
                BaseService.update(this.props.match.params.xSite, "/question/design/update/", this.state.survey.id + '/' + this.state.question.question_id, 
                this.selectUpdate( this.state.question, ['question_label', 'question_label_EN', 'question_label_html', 'question_label_EN_html', 'area_of_impact_id', 'enable_consent'], [this.state.question.question_label, this.state.question.question_label_EN, this.state.question.question_label_html, this.state.question.question_label_EN_html, strSelectedAreaOfImpactsId, this.state.question.enable_consent]), jwt).then(
                    (rp) => {
                        try{
                            if (rp.Status) {
                            // console.log(rp);
                                ...
                                BaseService.update(this.props.match.params.xSite, "/question/design/update/", this.state.survey.id + '/' + this.state.question.question_id + '/' + this.state.question.type_id, 
                                    ...
                                    (rp) => {
                                        ...
                                        // console.log(rp);
                                            ...
                                            // toastr.error(rp.Messages);
                                            toastr.error('Something went wrong!, please refresh the page or try again later.');
                                            BaseService.post(this.props.match.params.xSite, "/frontendlog/", { method: `checkboxQuestionForm onSaveEdit BaseService.update /question/design/update/${this.state.survey.id}/${this.state.question.question_id}/${this.state.question.type_id} else`, message: `Messages: ${rp.Messages} | Exception: ${rp.Exception}` }, getJwtToken()).then( (rp) => { console.log(`Messages: ${rp.Messages} | Exception: ${rp.Exception}`); });
                                        }
                                    }
                                );
                                ...
                                // toastr.error(rp.Messages);
                                toastr.error('Something went wrong!, please refresh the page or try again later.');
                                BaseService.post(this.props.match.params.xSite, "/frontendlog/", { method: `checkboxQuestionForm onSaveEdit BaseService.update /question/design/update/${this.state.survey.id}/${this.state.question.question_id} else`, message: `Messages: ${rp.Messages} | Exception: ${rp.Exception}` }, getJwtToken()).then( (rp) => { console.log(`Messages: ${rp.Messages} | Exception: ${rp.Exception}`); });
                            }
                        }catch(error){ 
                            toastr.error('Something went wrong!, please refresh the page or try again later.');
                            BaseService.post(this.props.match.params.xSite, "/frontendlog/", { method: `checkboxQuestionForm onSaveEdit BaseService.update /question/design/update/${this.state.survey.id}/${this.state.question.question_id} catch`, message: `catch: ${error}` }, getJwtToken()).then( (rp) => { console.log(`catch: ${error}`); });
                        }
                    }
                );
            }
            ...
            toastr.error('Something went wrong!, please refresh the page or try again later.');
            BaseService.post(this.props.match.params.xSite, "/frontendlog/", { method: `checkboxQuestionForm onSaveEdit catch`, message: `catch: ${error}` }, getJwtToken()).then( (rp) => { console.log(`catch: ${error}`); });
        }
    }
        ...
        this.props.form.setFieldsValue({
            ...
            if(id === 'answer_choice'){
                ...
                this.setState({
                    ...
                    // console.log(`choicesHtml`, this.state.choicesHtml);
                });
            }
                ...
                this.setState({
                    ...
                    // console.log(`choicesENHtml`, this.state.choicesENHtml);
                });
            }
        });
    };
    ...
    onAddCustomerConsentChange(e: any) {
        // console.log(`onAddCustomerConsentChange checked = ${e.target.checked}`);
  
        this.setState({
        question: {
            ...this.state.question,
            ['enable_consent']: e.target.checked ? 1 : 0,
        }
        }, () => {
                // console.log(`onAddCustomerConsentChange enable_consent = ${this.state.question.enable_consent}`);
            } 
        );
    ...
    public async renderLogicDropdownPageElement(j: any) {
        try{
            ...
            toastr.error('Something went wrong!, please refresh the page or try again later.');
            BaseService.post(this.props.match.params.xSite, "/frontendlog/", { method: `checkboxQuestionForm renderLogicDropdownPageElement catch`, message: `catch: ${error}` }, getJwtToken()).then( (rp) => { console.log(`catch: ${error}`); });
        }
    }
    ...
    public renderLogicDropdownQuestionElement(j: any, pageChanged?: boolean) {
        try{
            ...
            toastr.error('Something went wrong!, please refresh the page or try again later.');
            BaseService.post(this.props.match.params.xSite, "/frontendlog/", { method: `checkboxQuestionForm renderLogicDropdownQuestionElement catch`, message: `catch: ${error}` }, getJwtToken()).then( (rp) => { console.log(`catch: ${error}`); });
        }
    }
    ...
    public getAllQuestionOptionElementCopy(j: any){
        ...
        // console.log(`allQuestionOptionElementCopy loop ${j} removed`, allQuestionOptionElementCopy);
            ...
            toastr.error('Something went wrong!, please refresh the page or try again later.');
            BaseService.post(this.props.match.params.xSite, "/frontendlog/", { method: `checkboxQuestionForm getAllQuestionOptionElementCopy catch`, message: `catch: ${error}` }, getJwtToken()).then( (rp) => { console.log(`catch: ${error}`); });
        }
    }
    ...
    public async renderElement(key: any) { 
        ...
        // console.log('DropdownQuestionForm renderElement question', this.state.question);
            ...
            toastr.error('Something went wrong!, please refresh the page or try again later.');
            BaseService.post(this.props.match.params.xSite, "/frontendlog/", { method: `checkboxQuestionForm renderElement catch`, message: `catch: ${error}` }, getJwtToken()).then( (rp) => { console.log(`catch: ${error}`); });
        }
                      ...
                      // console.log(`get question ${i} count = `, rp.Data.recordset.length);
                        ...
                        if(rp.Data.recordset.length){
                          ...
                          // console.log(`get question no. ${i} questionPageNo = `, questionPageNo);
                            ...
                            // toastr.error(rp.Messages);
                            toastr.error('Something went wrong!, please refresh the page or try again later.');
                            BaseService.post(this.props.match.params.xSite, "/frontendlog/", { method: `checkboxQuestionForm getPageNo BaseService.get<Question> /question/${surveyId}/${i} else rp.Data.recordset.length`, message: `Messages: ${rp.Messages} | Exception: ${rp.Exception}` }, getJwtToken()).then( (rp) => { console.log(`Messages: ${rp.Messages} | Exception: ${rp.Exception}`); });
                            return false;
                        }
                        ...
                        // toastr.error(rp.Messages);
                        toastr.error('Something went wrong!, please refresh the page or try again later.');
                        BaseService.post(this.props.match.params.xSite, "/frontendlog/", { method: `checkboxQuestionForm getPageNo BaseService.get<Question> /question/${surveyId}/${i} else rp.Status`, message: `Messages: ${rp.Messages} | Exception: ${rp.Exception}` }, getJwtToken()).then( (rp) => { console.log(`Messages: ${rp.Messages} | Exception: ${rp.Exception}`); });
                        return false;
                    }
                }catch(error){
                    toastr.error('Something went wrong!, please refresh the page or try again later.');
                    BaseService.post(this.props.match.params.xSite, "/frontendlog/", { method: `checkboxQuestionForm getPageNo BaseService.get<Question> /question/${surveyId}/${i} catch`, message: `catch: ${error}` }, getJwtToken()).then( (rp) => { console.log(`catch: ${error}`); });
                }
            }//async (rp)
        );//call question api
    }
                ...
                try{
                    if (rp.Status) {
                      ...
                      // console.log(`get question ${no} count = `, rp.Data.recordset.length);
                        ...
                        // toastr.error(rp.Messages);
                        toastr.error('Something went wrong!, please refresh the page or try again later.');
                        BaseService.post(this.props.match.params.xSite, "/frontendlog/", { method: `checkboxQuestionForm getQuestionOptionRow BaseService.get<Question> /question/${this.state.survey.id}/${no} else`, message: `Messages: ${rp.Messages} | Exception: ${rp.Exception}` }, getJwtToken()).then( (rp) => { console.log(`Messages: ${rp.Messages} | Exception: ${rp.Exception}`); });
                        return <option key={this.state.actionKey+'-option-'+no}></option>;
                    }
                }catch(error){
                    toastr.error('Something went wrong!, please refresh the page or try again later.');
                    BaseService.post(this.props.match.params.xSite, "/frontendlog/", { method: `checkboxQuestionForm getQuestionOptionRow BaseService.get<Question> /question/${this.state.survey.id}/${no} catch`, message: `catch: ${error}` }, getJwtToken()).then( (rp) => { console.log(`catch: ${error}`); });
                }
            }//async (rp)
        );//call question api
    ...
    customRequest = (componentsData: any) => {
      // console.log('componentsData', componentsData);
          ...
          // console.log('after imageSourceArr', imageSourceArr); 
            ...
            this.setState({
              ...
              // console.log('this.state.imageSource', this.state.imageSource)
                ...
                // let imageSourceFieldName = componentsData.data.fieldName;
                // this.props.form.setFieldsValue({
                //     [imageSourceFieldName]: data.url
                // }, () => { /*console.log('setFieldsValue', imageSourceFieldName)*/ });
            });
        ...
        .catch(error => {
            toastr.error('Something went wrong!, please refresh the page or try again later.');
            BaseService.post(this.props.match.params.xSite, "/frontendlog/", { method: `checkboxQuestionForm customRequest catch`, message: `catch: ${error}` }, getJwtToken()).then( (rp) => { console.log(`catch: ${error}`); });
                ...
                <Tabs defaultActiveKey={this.state.actionKey} onChange={this.tabCall} className="tabs question-setting-tabs">
                    ...
                    <TabPane tab="EDIT" key="edit" className="bottom-space">
                        ...
                        <div className="editorSection">
                            ...
                            <div className={ this.props.match.params.xSite === "singha" ? "questionSetting starTable comment-box-setting-container" : "hidden" }>
                                <Checkbox onChange={this.onAddCustomerConsentChange.bind(this)} checked={this.state.question.enable_consent}>Add a Customer Consent section</Checkbox>
                            </div>
...
const checkboxQuestionForm = Form.create<Props>()(CheckboxQuestionForm);
