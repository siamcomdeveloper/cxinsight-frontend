...
import { AnnotationsTunnelTypeBackgroundOptions } from 'highcharts';
...
const BulletGraph: React.StatelessComponent<IProps> = (props) => { 
    ...
    try{
        return (
            ...
            {props.data.map((data: any) => {
                ...
                >
                    <Coord transpose />
                    {/* <Axis name="title" position="right" label={{ offset: 30, textStyle: { fill: "black", fontSize: '16', fontWeight: 'bold' } }}/> */}
                    <Axis name="actual" position="right" label={{ /*offset: 1,*/textStyle: { fill: "black", fontSize: '12' } }}/>
                    ...
                    <Guide>
                        ...
                        <Text
                            ...
                            position={(xScale, yScale)  =>{
                                //   return [0,5.8]; // location information
                                //   return [0,6]; // location information
                                return [0, props.nlocation]; // location information
                            }}
                            style={{
                                textAlign: 'center', // alignment of label text: 'start'|'middle'|'end'
                                fill: '#404040', // color of label text
        ...
        // BaseService.post("/frontendlog/", { method: 'BulletGraph catch', message: `catch: ${error}` }, getJwtToken()).then( (rp) => { console.log(`catch: ${error}`); });
        return (<div></div>); 
    }
}
