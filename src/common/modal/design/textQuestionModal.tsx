...
import TextQuestionForm from '../../form/design/textQuestionForm';
...
class TextQuestionModal extends React.Component<IProps, IState> { 
    ...
    constructor(props: IProps) {
      ...
      // console.log('TextQuestionModal constructor', props);
    }

    public componentDidMount() { 
      // console.log('TextQuestionModal componentDidMount');
    }

    componentWillReceiveProps(props: any) {
      // console.log('TextQuestionModal componentWillReceiveProps', props);
        this.setState({
            visible: props.visible
        });
    }
    ...
    handleCancel = (e: any) => {
      ...
      // console.log('TextQuestionModal handleCancel', this.state.visible);
    };
