...
const ChoiceRow: React.StatelessComponent<IProps> = (props) => { 
    ...
    return (
        ...
        <div className="sm-question-view clearfix sm-corner-a " sm-question-id="438586089" view-role="summaryQuestionViewContainer">
            ...
            <div sm-questionview-content="" className="sm-questionview-content " view-role="summaryMatrixRatingQuestionView" style={{ minHeight: '407px'}}>
                ...
                <div className="">
                    <div className="sm-chart" data-highcharts-chart="9" view-role="NpsSummaryChartView" style={{ paddingTop: '24px' }}>
                        ...
                        <table cellPadding="0" cellSpacing="0" className="sm-data-table sm-data-table-summary">
                            ...
                            <tfoot>
                                <tr style={{ background: 'none' }}>
                                    ...
                                    <td colSpan={1}>
                                        <div className="sm-data-table-liner sm-data-total" style={{fontWeight: 'bold'}}>{props.answer.sumAnswered}</div>
                                    </td>
                                </tr>
                                {/* <tr style={{ background: 'none' }}>
                                    <td>AVERAGE</td>
                                    <td></td>
                                    <td colSpan={1}>{props.answer.avg}</td>
                                </tr> */}
                            </tfoot>
                        </table>
                    </div>
